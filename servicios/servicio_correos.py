...
try:
    ...
    mensaje_registro = b'00010sinitcorreo'
    ...
    while True:
        ...
        partes = datos.split("|")
        if len(partes) == 2:
            email, mensaje = partes
            respuesta = f"correoOKCorreo enviado a {email} con mensaje: {mensaje}"
        else:
            respuesta = "correoNKFormato inválido"
